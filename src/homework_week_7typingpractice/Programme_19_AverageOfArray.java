...
public class Programme_19_AverageOfArray {
    public static void main(String[] args) {
        ...
        System.out.println( " Values of the elemetns of the array are " + Arrays.toString(numArray));
        System.out.println(" Average of all the value of teh array are:  " + average);
        }
    }