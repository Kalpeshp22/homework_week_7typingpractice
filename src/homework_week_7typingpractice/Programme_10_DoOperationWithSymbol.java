...
public class Programme_10_DoOperationWithSymbol {
    public static void main(String[] args) {
        // Scanner declartion for reading inpur from console
        ...
        doOperatoinBySelectingSymbol(x, y, symbol);
        // clsoing the scanner object
        scanner.close();

    }
      // Calculationg operation based on symbol
    public static void doOperatoinBySelectingSymbol( int x,int y, char symbol){
        if (symbol == '+') {
